...
装的是预编译好的包，不在本机编译、不拉依赖；链接始终指向最新 Release。不想装 Node 就从 [Releases](https://github.com/stepfun-ai/Step-Realtime-CLI/releases/latest) 下对应平台的单文件可执行（Windows / macOS / Linux）；要改代码请走源码安装。
