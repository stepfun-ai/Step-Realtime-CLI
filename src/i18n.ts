...
const zh = {
  ...
  'app.goal.arg.status': '查看目标状态面板',
  'app.goal.arg.pause': '暂停自主推进（/goal resume 恢复）',
  'app.goal.arg.resume': '恢复自主推进',
  'app.goal.arg.cancel': '取消并清除当前目标',
  'app.permission.arg.manual': '每次工具调用都询问',
  'app.permission.arg.auto': '自动批准安全操作，危险操作仍询问',
  'app.permission.arg.yolo': '全部自动批准（不再询问）',
  'app.provider.arg.list': '列出当前服务商与自定义渠道',
  'app.provider.arg.add': '新增渠道向导（手动录入或目录导入）',
  'app.provider.arg.custom': '自定义渠道',
  'app.provider.arg.preset': '内置预设',
  'app.lang.arg.zh': '切换为中文界面',
  'app.lang.arg.en': '切换为英文界面',
  'app.plugin.arg.list': '列出已安装 plugin',
  'app.plugin.arg.install': '从本地目录安装 plugin',
  'app.plugin.arg.enable': '启用指定 plugin',
  'app.plugin.arg.disable': '禁用指定 plugin',
  'app.plugin.arg.remove': '卸载指定 plugin',
  'app.plugin.arg.info': '查看 plugin 详情',
  'app.plugin.arg.id': 'plugin id',
  ...
  'loop.roundLoop.warn': '检测到连续 {n} 轮产出完全相同（工具调用与结果均无变化），已注入警告提示模型换方法。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'app.goal.arg.status': 'View the goal status panel',
  'app.goal.arg.pause': 'Pause autonomous progress (resume with /goal resume)',
  'app.goal.arg.resume': 'Resume autonomous progress',
  'app.goal.arg.cancel': 'Cancel and clear the current goal',
  'app.permission.arg.manual': 'Ask before every tool call',
  'app.permission.arg.auto': 'Auto-approve safe operations; still ask for dangerous ones',
  'app.permission.arg.yolo': 'Auto-approve everything (never ask)',
  'app.provider.arg.list': 'List current provider and custom channels',
  'app.provider.arg.add': 'Add-channel wizard (manual entry or catalog import)',
  'app.provider.arg.custom': 'Custom channel',
  'app.provider.arg.preset': 'Built-in preset',
  'app.lang.arg.zh': 'Switch to Chinese UI',
  'app.lang.arg.en': 'Switch to English UI',
  'app.plugin.arg.list': 'List installed plugins',
  'app.plugin.arg.install': 'Install a plugin from a local directory',
  'app.plugin.arg.enable': 'Enable a plugin',
  'app.plugin.arg.disable': 'Disable a plugin',
  'app.plugin.arg.remove': 'Uninstall a plugin',
  'app.plugin.arg.info': 'Show plugin details',
  'app.plugin.arg.id': 'plugin id',
  ...
  'loop.roundLoop.warn': 'Detected identical output for {n} consecutive rounds (tool calls and results unchanged); injected a warning asking the model to try a different approach.',
  'loop.roundLoop.inject': 'You have produced identical content and tool calls for multiple consecutive rounds, with no change in tool results. This is a zero-progress loop. Try a different approach immediately; if you genuinely cannot make progress, stop calling tools and report the current blocker and what you have learned so far directly to the user.',
